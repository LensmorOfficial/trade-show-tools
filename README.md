...
- [trade-show-calendar](https://github.com/LensmorOfficial/trade-show-calendar) — Open dataset of 109 global trade shows (CSV + JSON)
...
Have ideas for new tools or improvements? Open an issue or submit a PR.
